...
class TextureGenerator:
    ...
    def get_assets(distance):
        ...
        planet_texture.save("/assets/textures/planet_texture.png")
        water_mask.save("/assets/textures/water_mask.png")
        cloud_image.save("/assets/textures/cloud_image.png")
        return 0

#example case
# response = TextureGenerator.get_assets(5.0)